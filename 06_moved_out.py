...
for xlsx in files :
    if xlsx.endswith(".xlsx"):
        ...
        dta = pd.read_excel(raw  + xlsx, sheet_name = '05_moved_out', \
...
if obs > 0 :
    ...
    writer = pd.ExcelWriter(output + region + '_' + qrt + '_moveout_check.xlsx', engine = 'xlsxwriter')
